export const transitstatus_agencies = {
  amtraker: {
    name: "Amtraker",
    ...
    mapShapes: [
      ...
      "https://gtfs.piemadd.com/data/viarail/shapes/type_2.geojson",
    ],
    gtfsRoot: "https://gtfs.piemadd.com/data/amtrak",
    mapDefault: [44.550927211989006, -96.81407102410003, 2.8335119586615156],
    color: "#024D77",
    textColor: "#F7F7F7F7",
    type: 'Train',
    typePlural: 'Trains',
  ...
  ctat: {
    ...
    mapDefault: [41.898005831632275, -87.75504000000001, 9.627127509206744],
    color: "#2166b1",
    textColor: "#ffffff",
    type: 'Train',
    typePlural: 'Trains',
  ...
  */
  metra: {
    ...
    mapDefault: [42.00475792386317, -88.08264000000003, 7.889881795198541],
    color: "#005195",
    textColor: "#ffffff",
    type: 'Train',
    typePlural: 'Trains',
